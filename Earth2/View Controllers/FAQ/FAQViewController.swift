...
class FAQViewController: UIViewController {
    ...
    fileprivate lazy var faqItems: [FAQItem] = {
        ...
        items += [FAQItem(question: "Can I purchase and/or sell properties through the app?", answer: "No, sorry. This app is not meant to replace E2 but to enhance your gaming experience. Due to technical limitations, we are currently unable to display the E2 map nor implement any transactional feature.")]
        items += [FAQItem(question: "Can I browse the market place?", answer: "Not at this time. We me integrate that feature and similar listing, in the future.")]
        ...
        items += [FAQItem(question: "Why is this app slow to login to earth2.io?", answer: "The proxy server is not the fastest during the beta phase. We will upgrade to a faster server once the application is released on the App Store.")]
        ...
        items += [FAQItem(question: "Is the source code of this app available?", answer: "Soon! We will open source this application's source code on Github in order to give full transparency on how things are done. This will be particularly useful if you are familiar with programming.")]
