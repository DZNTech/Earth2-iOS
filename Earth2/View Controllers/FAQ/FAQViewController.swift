...
class FAQViewController: UIViewController {
    ...
    fileprivate lazy var faqItems: [FAQItem] = {
        ...
        items += [FAQItem(question: "Why is the app slow to login to earth2.io?", answer: "During the beta phase, the proxy server in use is not the fastest (free tier). We will upgrade to a faster and more secure server once the app is released on the App Store.")]
        items += [FAQItem(question: "Are my E2 credentials being stored or logged?", answer: "The proxy server is stateless: NO information is being tracked, stored nor logged in the server. \(StringConstants.credentialSavingDisc). You can disable this feature from within the application settings.")]
        items += [FAQItem(question: "Is my E2 data stored or logged?", answer: "The proxy server is stateless: NO information is being tracked, stored nor logged in the server. \(StringConstants.dataSavingDisc). You can disable this feature from within the app settings.")]
        items += [FAQItem(question: "How do I send you feedback or questions?", answer: "You can send us bug reports, ideas or questions about the app here: \(WebConstant.feebackShort.rawValue). The form is also available from within the app settings.")]
        items += [FAQItem(question: "Can I share this beta app with friends?", answer: "You can invite your friends to test the beta app by sharing this link with them: \(WebConstant.testFlight.rawValue)")]
        items += [FAQItem(question: "Is the source code of this app available?", answer: "Soon! We will open source this app's source code on Github in order to give full transparency on how things work internally. This will be particularly useful if you are familiar with Apple's Swift programming and want to contribute to improve this app.")]
