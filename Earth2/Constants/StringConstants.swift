...
enum StringConstants {
    ...
    static let dataSavingDisc = "For a better user experience, your E2 data is safely encrypted and ONLY stored locally. This helps speeding up the app launch, displaying outdated information while loading new data. Only User and Property data that you see on screen are being stored"
